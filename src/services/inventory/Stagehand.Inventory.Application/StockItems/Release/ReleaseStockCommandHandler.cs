...
internal sealed class ReleaseStockCommandHandler : ICommandHandler<ReleaseStockCommand, Result>
{
    private readonly IStockItemRepository _stockItemRepository;
    private readonly IUnitOfWork _unitOfWork;

    public ReleaseStockCommandHandler(IStockItemRepository stockItemRepository, IUnitOfWork unitOfWork)
    {
